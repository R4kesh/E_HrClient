...
import ImplimentableDevice from '../components/ImplimentableDevice/ImplimentableDevice'

const ImplimentationDevicePage = () => {
  return (
...
export default ImplimentationDevicePage
