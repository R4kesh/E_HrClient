...
//                 <li className="bg-[#EEF7FF] text-sidebarMenu flex items-center gap-2 p-2 rounded-lg font-medium shadow-sm hover:shadow-lg hover:bg-blue-100 transition border-l-4 duration-100 transform hover:-translate-y-1">
        ...
        <div className="p-2">
          ...
          <ul className="space-y-1">
            {filteredItems.map((item, index) => (
              <Link key={index} to={item.path}>
                <li
                  className={`flex items-center gap-2 p-2 rounded-lg font-medium shadow-sm hover:shadow-lg transition border-l-4 duration-100 transform hover:-translate-y-1 ${location.pathname === item.path ? 'bg-blue-400 text-white border-blue-700' : 'bg-[#EEF7FF] text-sidebarMenu hover:bg-blue-100'}`}
                >
                  {item.icon} {item.label}
                </li>
              </Link>
