...
//                     <button
//                       key={factor}
//                       onClick={() => addRiskFactor(factor)}
//                       className="flex items-center justify-center p-3 text-sm rounded-lg border border-gray-200 hover:bg-blue-50 hover:border-blue-300 transition-all duration-200 hover:shadow-md group"
//                     >
